...
namespace TextAssetService.Migrations
{
    ...
    [Migration("20200624183005_AddingFileTypes")]
    partial class AddingFileTypess
    {
            ...
            modelBuilder.Entity("TextAssetService.Models.TextAsset", b =>
                {
                    ...
                    b.Property<long>("FileTypeAssetTypeId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("FileTypeAssetTypeId");
            ...
            modelBuilder.Entity("TextAssetService.Models.TextAsset", b =>
                {
                    ...
                    b.HasOne("TextAssetService.Models.AssetType", "FileType")
                        .WithMany()
                        .HasForeignKey("FileTypeAssetTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
